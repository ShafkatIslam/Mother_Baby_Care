...
import com.example.professt.mother_baby_care.Mother.DoctorFind.CustomAdapter;
...
public class DoctorListsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_lists);

        prepareListdata();          //calling a method

        expandableListView = (ExpandableListView) findViewById(R.id.expandableListViewIds);
    ...
    public void onBackPressed() {           //creating method of onBackPressed
        ...
        Intent intent =  new Intent(DoctorListsActivity.this,HospitalsActivity.class);
