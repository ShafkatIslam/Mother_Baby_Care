...
import com.example.professt.mother_baby_care.Baby.NearestHealth.NearbyHospitalDetail;
...
public class GeometryControllers {
        ...
        try {
            ...
            for(int i=0; i<array.length(); i++){
                try {
                    ...
                    NearbyHospitalDetail hospitalsDetail = new NearbyHospitalDetail();
