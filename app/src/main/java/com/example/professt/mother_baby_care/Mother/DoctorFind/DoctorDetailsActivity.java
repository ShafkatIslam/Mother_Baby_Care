...
public class DoctorDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorNames = (TextView)findViewById(R.id.doctorName);
        doctorNumber = (TextView)findViewById(R.id.doctorNumber);
        doctorHospital = (TextView)findViewById(R.id.doctorHospital);
    ...
    public void onBackPressed() {           //creating method of onBackPressed
        ...
        Intent intent =  new Intent(DoctorDetailsActivity.this,DoctorNameActivity.class);
