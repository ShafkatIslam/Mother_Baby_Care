...
public class DoctorReminderCustomAdapter extends BaseAdapter {

    Context ctx;
    LayoutInflater lInflater;
    ArrayList<DoctorReminder> objects1;

    String parsedDate1,parsedDate2;
    int id,id1;

    public DoctorReminderCustomAdapter(Context context, ArrayList<DoctorReminder> products) {
        ctx = context;
        objects1 = products;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DoctorReminder doctorReminder = getFriends(position);

        String time = doctorReminder.getPreviouMeeting();
        String time1 = doctorReminder.getNextMeeting();

        id = doctorReminder.getId();
        id1 = doctorReminder.getId1();
        ...
        try {
            ...
            if(id1 == 1)
            {
                ...
                ((TextView) view.findViewById(R.id.next)).setText("Next Meeting: ");
            ...
            else
            {
                ...
                ((TextView) view.findViewById(R.id.previous)).setText("Previous Meeting: ");
                ((TextView) view.findViewById(R.id.next)).setText("Next Meeting: ");
    ...
    private DoctorReminder getFriends(int position) {
        return ((DoctorReminder) getItem(position));
    }
}
