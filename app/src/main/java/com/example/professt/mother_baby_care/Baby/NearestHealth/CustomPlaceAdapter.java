...
public class CustomPlaceAdapter extends BaseAdapter {
    ...
    public CustomPlaceAdapter(Context context, ArrayList<String> placeName, ArrayList<String> ratingText, ArrayList<String> openNowText) {
