...
import com.example.professt.mother_baby_care.ReminderMother.DoctorReminder.VaccineReminder;
...
public class ChildReminderCustomAdapter extends BaseAdapter {

    Context ctx;
    LayoutInflater lInflater;
    ArrayList<ChildReminder> objects1;

    String parsedDate1,parsedDate2;
    int id,id1;

    public ChildReminderCustomAdapter(Context context, ArrayList<ChildReminder> products) {
        ctx = context;
        objects1 = products;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ChildReminder childReminder = getFriends(position);

        String time = childReminder.getPreviouMeeting();
        String time1 = childReminder.getNextMeeting();

        id = childReminder.getId();
        id1 = childReminder.getId1();
    ...
    private ChildReminder getFriends(int position) { return ((ChildReminder) getItem(position));
    }
}
