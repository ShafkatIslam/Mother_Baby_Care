...
public class ForgetVaccineActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forget_vaccine);

        VaccineSelectDateButtonId1 = (Button)findViewById(R.id.VaccineSelectDateButtonId1);
        vaccineDone2ButtonId1 = (Button)findViewById(R.id.vaccineDone2ButtonId1);

        vaccineDateTextViewId1 = (TextView)findViewById(R.id.vaccineDateTextViewId1);
        VaccineNoId1 = (TextView)findViewById(R.id.VaccineNoId1);

        vacchineNumber1 = (Spinner) findViewById(R.id.vacchineNumber1);
        ...
        VaccineSelectDateButtonId1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePicker datePicker = new DatePicker(ForgetVaccineActivity.this);
                int currentday= datePicker.getDayOfMonth();
                int currentMonth = (datePicker.getMonth());
                int currentYear = datePicker.getYear();
                datePickerDialog = new DatePickerDialog(ForgetVaccineActivity.this,
...
//                                eventClass.setDate(result);
        ...
        vaccineDone2ButtonId1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ForgetVaccineActivity.this, "Please Select Vacchine No", Toast.LENGTH_SHORT).show();
                }

                else if(date1.isEmpty())
                {
                    Toast.makeText(ForgetVaccineActivity.this, "Please Select Date", Toast.LENGTH_SHORT).show();
                }
                ...
                else
                {
                    ...
                    loading = new ProgressDialog(ForgetVaccineActivity.this);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Key.VACCINATION_URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equals("success")) {
                                ...
                                Intent intent = new Intent(ForgetVaccineActivity.this, MotherHomeActivity.class);
                                startActivity(intent);

                                Toast.makeText(ForgetVaccineActivity.this, "Inserted Successfull", Toast.LENGTH_SHORT).show();



                            } else if (response.equals("exists")) {
                                Toast.makeText(ForgetVaccineActivity.this, "Vaccine already exists", Toast.LENGTH_SHORT).show();
                                loading.dismiss();
                            } else if (response.equals("failure")) {
                                Toast.makeText(ForgetVaccineActivity.this, "Not Inserted", Toast.LENGTH_SHORT).show();
                                loading.dismiss();
                            }
                        }
                    },
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(ForgetVaccineActivity.this, "There is an error", Toast.LENGTH_SHORT).show();
                                    loading.dismiss();
                                }
                            }){
                        @Override
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(ForgetVaccineActivity.this);
