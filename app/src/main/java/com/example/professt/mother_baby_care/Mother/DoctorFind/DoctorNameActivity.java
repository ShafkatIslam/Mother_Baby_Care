...
public class DoctorNameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter1 = new ArrayAdapter<String>(DoctorNameActivity.this,R.layout.sample_view,R.id.textViewId,doctorNames); //creating object of ArrayAdapter....thre are 4 parameters in ArrayAdapter
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DoctorNameActivity.this,DoctorDetailsActivity.class);
    ...
    public void onBackPressed() {           //creating method of onBackPressed
        ...
        Intent intent =  new Intent(DoctorNameActivity.this,DoctorFindActivity.class);
        startActivity(intent);
