package com.example.professt.mother_baby_care.Baby.NearestHealth;
...
import com.example.professt.mother_baby_care.Mother.Nearest_Hospital.CustomPlacesAdapter;
import com.example.professt.mother_baby_care.Mother.Nearest_Hospital.GeometryController;
import com.example.professt.mother_baby_care.Mother.Nearest_Hospital.ListHealthCenters;
import com.example.professt.mother_baby_care.Mother.Nearest_Hospital.MapsActivity;
...
public class ListHealthCenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_health_center);

        /** initializing centers list view to show results of nearby hospitals on list */
        centersListView = (ListView) findViewById(R.id.centerListView);
        ...
        viewMapButton = (Button) findViewById(R.id.viewerMapButton);
        ...
        /** initializing */
        scanButton = (Button) findViewById(R.id.scanerButton);
        ...
        scanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(ListHealthCenter.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListHealthCenter.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    BabyHomeActivity.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
    ...
    void viewMapButton() {
         ...
         * @param MapsActivity
         * */
        Intent intent = new Intent(ListHealthCenter.this, MapActivity.class);
    ...
    protected void fillList() {
        ...
        CustomPlaceAdapter customPlaceAdapter = new CustomPlaceAdapter(this, placeName, ratingText, openNow);
        centersListView.setAdapter(customPlaceAdapter);
        BabyHomeActivity.progressDialog.cancel();
    }
    ...
    void loadLocation() {
        try {
            new ListHealthCenter.RetrieveFeedTask().execute();
            new Thread(new Runnable() {
                @Override
                public void run() {
                    while (stringBuffer.length() == 0) Log.d("Messege", "buffer reading");
                    GeometryController.manipulateData(ListHealthCenter.stringBuffer);
                }
            }).start();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    class RetrieveFeedTask extends AsyncTask<StringBuffer, StringBuffer, StringBuffer > {
        ...
        protected StringBuffer doInBackground(StringBuffer... stringBuffers) {
            try {
                ...
                ListHealthCenter.stringBuffer = buffer;
                return buffer;
