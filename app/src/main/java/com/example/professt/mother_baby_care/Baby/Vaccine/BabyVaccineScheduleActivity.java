...
import com.example.professt.mother_baby_care.Mother.Vaccine.Vaccine;
...
public class BabyVaccineScheduleActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        setContentView(R.layout.activity_baby_vaccine_schedule);

        VaccineSelectDateButtonId = (Button) findViewById(R.id.VaccineSelectDateButtonIds);
        VaccineSelectDateButton2Id = (Button) findViewById(R.id.VaccineSelectDateButton2Ids);
        vaccineDone2ButtonId = (Button) findViewById(R.id.vaccineDone2ButtonIds);
        okButtonId = (Button) findViewById(R.id.okButtonIds);
        ok2ButtonId = (Button) findViewById(R.id.ok2ButtonIds);
        VaccineDoneButtonId = (Button) findViewById(R.id.VaccineDoneButtonIds);

        vaccineDateTextViewId = (TextView) findViewById(R.id.vaccineDateTextViewIds);
        VaccineNoId = (TextView) findViewById(R.id.VaccineNoIds);
        VaccineNotextId = (TextView) findViewById(R.id.VaccineNotextIds);
        vaccinenoId = (TextView)findViewById(R.id.vaccinenoId);
        nextVaccineId = (TextView) findViewById(R.id.nextVaccineIds);
        vaccineDateText2ViewId = (TextView) findViewById(R.id.vaccineDateText2ViewIds);
        previousVaccineId = (TextView) findViewById(R.id.previousVaccineIds);
        vaccineDateText3ViewId = (TextView) findViewById(R.id.vaccineDateText3ViewIds);
        vaccineId = (TextView) findViewById(R.id.vaccineIds);
        takenId = (TextView) findViewById(R.id.takenIds);
        currentVaccineId = (TextView) findViewById(R.id.currentVaccineIds);
        vacchineNumber = (Spinner) findViewById(R.id.vacchineNumbers);
        radioGrroup = (RadioGroup) findViewById(R.id.radioGroupIds);
...
//        noCheckBox = (CheckBox)findViewById(R.id.noCheckBoxId);
        ...
        loading = new ProgressDialog(BabyVaccineScheduleActivity.this);
        loading.setIcon(R.drawable.wait_icon);
        loading.setTitle("Loading");
        loading.setMessage("Please wait....");
        loading.show();

            String URL = Key.BABY_VACCINATION_CHECK+getCell;
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Intent intent = new Intent(BabyVaccineScheduleActivity.this,MotherHomeActivity.class);
                            startActivity(intent);
                            loading.dismiss();
                            Toast.makeText(BabyVaccineScheduleActivity.this, "Network Error!", Toast.LENGTH_SHORT).show();
                        }
                    });

            RequestQueue requestQueue = Volley.newRequestQueue(BabyVaccineScheduleActivity.this);
...
//                noCheckBox.setVisibility(View.GONE);
                ...
                VaccineSelectDateButtonId.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DatePicker datePicker = new DatePicker(BabyVaccineScheduleActivity.this);
                        int currentday= datePicker.getDayOfMonth();
                        int currentMonth = (datePicker.getMonth());
                        int currentYear = datePicker.getYear();
                        datePickerDialog = new DatePickerDialog(BabyVaccineScheduleActivity.this,
...
//                                        mother1.setId2(j);
                ...
                okButtonId.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(date1.isEmpty())
                        {
                            Toast.makeText(BabyVaccineScheduleActivity.this,"Please select current date",Toast.LENGTH_SHORT).show();
                        }
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, Key.BABY_VACCINATION_URL, new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    if (response.equals("success")) {
                                        ...
                                        Intent intent = new Intent(BabyVaccineScheduleActivity.this, BabyHomeActivity.class);
                                        startActivity(intent);

                                        Toast.makeText(BabyVaccineScheduleActivity.this, "Inserted Successfull", Toast.LENGTH_SHORT).show();



                                    } else if (response.equals("exists")) {
                                        Toast.makeText(BabyVaccineScheduleActivity.this, "User already exists", Toast.LENGTH_SHORT).show();
                                        loading.dismiss();
                                    } else if (response.equals("failure")) {
                                        Toast.makeText(BabyVaccineScheduleActivity.this, "Not Inserted", Toast.LENGTH_SHORT).show();
                                        loading.dismiss();
                                    }
                                }
                            },
                                    new Response.ErrorListener() {
                                        @Override
                                        public void onErrorResponse(VolleyError error) {
                                            Toast.makeText(BabyVaccineScheduleActivity.this, "There is an error", Toast.LENGTH_SHORT).show();
                                            loading.dismiss();
                                        }
                                    }){
                                @Override
...
//
                ...
                vaccineDone2ButtonId.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {
                            Toast.makeText(BabyVaccineScheduleActivity.this, "Please Select Vacchine No", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
...
//                                                                    if(total4>(totalssss-1))
                                                                    {
                                                                        if(count1==1)
                                                                        {
                                                                            if(month2==1 || month2==3 || month2==5 || month2==7 || month2==8 || month2==10 || month2==12)
                                                                            {
                                                                                total4 = total3+dayOfMonth+41;
                                                                            }
                                                                            else
                                                                            {
                                                                                total4 = total3+dayOfMonth+42;
                                                                            }
                                                                        ...
                                                                        else if(count1==3)
                                                                        {
                                                                            if(month2==1 || month2==3 || month2==5 || month2==7 || month2==8 || month2==10 || month2==12)
                                                                            {
                                                                                total4 = total3+dayOfMonth+98;
                                                                            }
                                                                            else
                                                                            {
                                                                                total4 = total3+dayOfMonth+99;
                                                                            }
                                                                        ...
                                                                        else if(count1==5)
                                                                        {
                                                                            if(month2==1 || month2==3 || month2==5 || month2==7 || month2==8 || month2==10 || month2==12)
                                                                            {
                                                                                total4 = total3+dayOfMonth+210;
                                                                            }
                                                                            else
                                                                            {
                                                                                total4 = total3+dayOfMonth+211;
                                                                            }
                                                                        ...
                                                                        else if(count1==6)
                                                                        {
                                                                            if(month2==1 || month2==3 || month2==5 || month2==7 || month2==8 || month2==10 || month2==12)
                                                                            {
                                                                                total4 = total3+dayOfMonth+270;
                                                                            }
                                                                            else
                                                                            {
                                                                                total4 = total3+dayOfMonth+271;
                                                                            }
                                                                        ...
                                                                        else if(count1==7)
                                                                        {
                                                                            if(month2==1 || month2==3 || month2==5 || month2==7 || month2==8 || month2==10 || month2==12)
                                                                            {
                                                                                total4 = total3+dayOfMonth+365;
                                                                            }
                                                                            else
                                                                            {
                                                                                total4 = total3+dayOfMonth+366;
                                                                            }
...
//                                                                    }
                                    ...
                                    {
                                        Toast.makeText(BabyVaccineScheduleActivity.this,"Please select anything",Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
...
//                                                else
//                                                {
//                                                    Toast.makeText(BabyVaccineScheduleActivity.this,"You can only take vacchine after completing your last settled vacchine.\nPlease check your Vacchination List",Toast.LENGTH_SHORT).show();
//                                                }
//
//                                            }
//                                        },currentYear,currentMonth,currentday);
                                ...
                                if(radioGrroup.getCheckedRadioButtonId()!=-1)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            StringRequest stringRequest = new StringRequest(Request.Method.POST, Key.BABY_VACCINATION_UPDATE, new Response.Listener<String>() {
                                                @Override
                                                public void onResponse(String response) {
                                                    ...
                                                    if (response.equals("success")) {
                                                        ...
                                                        Toast.makeText(BabyVaccineScheduleActivity.this, "Updated Successfull", Toast.LENGTH_SHORT).show();



                                                    } else if (response.equals("failure")) {
                                                        Toast.makeText(BabyVaccineScheduleActivity.this, "Not Update", Toast.LENGTH_SHORT).show();
                                                        loading.dismiss();
                                                    }
                                                }
                                            },
